...
export type SvmSpoke = {
  address: "8w5ayAyaEFdQtnn74xBZEeyaYd7dcdBLZV7hCHgNcNGs";
  metadata: {
    name: "svmSpoke";
    version: "0.1.0";
    spec: "0.1.0";
  ...
  instructions: [
    {
      ...
      discriminator: [1, 83, 255, 59, 232, 55, 64, 216];
      accounts: [
        {
          name: "signer";
          signer: true;
        ...
        },
        {
          ...
          pda: {
            seeds: [
              {
                kind: "const";
                value: [116, 114, 97, 110, 115, 102, 101, 114, 95, 108, 105, 97, 98, 105, 108, 105, 116, 121];
              },
              {
                kind: "account";
                path: "mint";
    ...
    },
    {
      ...
      discriminator: [205, 34, 34, 224, 204, 103, 81, 176];
      accounts: [
        {
          name: "signer";
          signer: true;
    ...
    },
    {
      ...
      discriminator: [224, 39, 208, 68, 8, 226, 23, 214];
      accounts: [
        {
          name: "signer";
          writable: true;
    ...
    },
    {
      ...
      discriminator: [224, 44, 254, 10, 216, 8, 172, 96];
      accounts: [
        {
          name: "signer";
          writable: true;
        ...
        },
        {
          ...
          pda: {
            seeds: [
              {
                kind: "const";
                value: [105, 110, 115, 116, 114, 117, 99, 116, 105, 111, 110, 95, 112, 97, 114, 97, 109, 115];
              },
              {
                kind: "account";
                path: "signer";
    ...
    },
    {
      ...
      discriminator: [163, 216, 49, 204, 97, 16, 80, 167];
      accounts: [
        {
          name: "signer";
          writable: true;
    ...
    },
    {
      ...
      discriminator: [75, 228, 135, 221, 200, 25, 148, 26];
      accounts: [
        {
          name: "signer";
          writable: true;
    ...
    },
    {
      ...
      discriminator: [226, 158, 1, 74, 84, 113, 24, 152];
      accounts: [
        {
          name: "signer";
          signer: true;
        ...
        },
        {
          ...
          pda: {
            seeds: [
              {
                kind: "const";
                value: [114, 111, 111, 116, 95, 98, 117, 110, 100, 108, 101];
              },
              {
                kind: "account";
                path: "state.seed";
    ...
    },
    {
      ...
      discriminator: [27, 136, 159, 240, 127, 68, 123, 164];
      accounts: [
        {
          name: "signer";
          writable: true;
    ...
    },
    {
      ...
      discriminator: [110, 112, 89, 208, 38, 116, 93, 10];
      accounts: [
        {
          name: "signer";
          writable: true;
    ...
    },
    {
      ...
      discriminator: [26, 207, 3, 168, 193, 252, 59, 127];
      accounts: [
        {
          name: "signer";
          signer: true;
    ...
    },
    {
      ...
      discriminator: [100, 84, 222, 90, 106, 209, 58, 222];
      accounts: [
        {
          name: "signer";
          writable: true;
    ...
    },
    {
      ...
      discriminator: [118, 10, 135, 0, 168, 243, 223, 117];
      accounts: [];
      args: [
        {
          name: "signer";
    ...
    },
    {
      ...
      discriminator: [133, 102, 1, 180, 145, 11, 138, 180];
      accounts: [
        {
          name: "authorityPda";
          signer: true;
        ...
        },
        {
          ...
          pda: {
            seeds: [
              {
                kind: "const";
                value: [115, 101, 108, 102, 95, 97, 117, 116, 104, 111, 114, 105, 116, 121];
              }
            ];
          };
        },
    ...
    },
    {
      ...
      discriminator: [22, 247, 214, 191, 90, 74, 87, 216];
      accounts: [
        {
          name: "signer";
          writable: true;
    ...
    },
    {
      ...
      discriminator: [94, 206, 190, 192, 127, 8, 186, 28];
      accounts: [
        {
          name: "signer";
          writable: true;
    ...
    },
    {
      ...
      discriminator: [92, 114, 214, 49, 13, 243, 73, 35];
      accounts: [
        {
          name: "signer";
          signer: true;
    ...
    },
    {
      ...
      discriminator: [69, 13, 223, 204, 251, 61, 105, 6];
      accounts: [
        {
          name: "signer";
          signer: true;
    ...
    },
    {
      ...
      discriminator: [39, 157, 165, 187, 88, 217, 207, 98];
      accounts: [
        {
          name: "signer";
          writable: true;
    ...
    },
    {
      ...
      discriminator: [102, 206, 237, 106, 63, 141, 42, 248];
      accounts: [
        {
          name: "signer";
          signer: true;
    ...
    {
      name: "setCurrentTime";
      docs: ["Sets the current time for the SVM Spoke Pool when running in test mode. Disabled on Mainnet."];
      discriminator: [69, 100, 169, 193, 125, 0, 150, 69];
      accounts: [
        {
          name: "state";
          writable: true;
    ...
    },
    {
      ...
      discriminator: [196, 187, 166, 179, 3, 146, 150, 246];
      accounts: [
        {
          name: "signer";
          writable: true;
    ...
    },
    {
      ...
      discriminator: [238, 182, 109, 113, 124, 255, 72, 18];
      accounts: [
        {
          name: "signer";
          signer: true;
  ...
  accounts: [
    ...
    },
    {
      ...
      discriminator: [192, 59, 93, 9, 171, 77, 28, 250];
    },
    {
      name: "executeSlowRelayLeafParams";
      discriminator: [135, 208, 119, 251, 14, 222, 66, 155];
    },
    {
      name: "fillRelayParams";
      discriminator: [50, 243, 51, 185, 89, 60, 43, 202];
    },
    {
      name: "fillStatusAccount";
      discriminator: [105, 89, 88, 35, 24, 147, 178, 137];
    },
    {
      name: "requestSlowFillParams";
      discriminator: [5, 54, 214, 89, 197, 37, 118, 28];
    },
    {
      name: "rootBundle";
      discriminator: [66, 221, 214, 231, 25, 222, 184, 219];
    },
    {
      name: "state";
    ...
    {
      name: "transferLiability";
      discriminator: [157, 137, 86, 109, 206, 241, 183, 79];
    }
  ];
  events: [
    {
      name: "bridgedToHubPool";
      discriminator: [181, 111, 52, 218, 105, 53, 240, 205];
    },
    {
      name: "claimedRelayerRefund";
      discriminator: [161, 134, 155, 159, 211, 37, 150, 41];
    },
    {
      name: "emergencyDeletedRootBundle";
      discriminator: [45, 150, 89, 248, 134, 142, 200, 114];
    },
    {
      name: "executedRelayerRefundRoot";
      discriminator: [198, 167, 248, 175, 34, 3, 4, 240];
    },
    {
      name: "filledRelay";
      discriminator: [25, 58, 182, 0, 50, 99, 160, 117];
    },
    {
      name: "fundsDeposited";
    ...
    {
      name: "pausedDeposits";
      discriminator: [94, 129, 187, 122, 94, 30, 91, 247];
    },
    {
      name: "pausedFills";
      discriminator: [81, 4, 134, 23, 170, 56, 234, 234];
    },
    {
      name: "relayedRootBundle";
      discriminator: [188, 206, 117, 10, 66, 78, 77, 115];
    },
    {
      name: "requestedSlowFill";
      discriminator: [221, 123, 11, 14, 71, 37, 178, 167];
    },
    {
      name: "setXDomainAdmin";
      discriminator: [164, 13, 119, 18, 103, 226, 98, 66];
    },
    {
      name: "tokensBridged";
      discriminator: [200, 201, 199, 39, 5, 238, 214, 196];
    },
    {
      name: "transferredOwnership";
      discriminator: [235, 235, 154, 16, 153, 94, 21, 117];
    }
  ];
  errors: [
    {
